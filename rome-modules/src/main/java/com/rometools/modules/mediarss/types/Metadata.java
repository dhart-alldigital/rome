 ...
 * &lt;channel&gt;, &lt;item&gt;, &lt;media:content&gt; and/or
 * &lt;media:group&gt;.
 *
 *
 * </p>
 ...
 * &lt;item&gt;, it means that the element should be applied to every media
 ...
 * higher priority over other levels.
 *
 * For example, &lt;media:content&gt; level elements are favored over
 * &lt;item&gt; level elements. The priority level is listed from strongest to
 * weakest: &lt;media:content&gt;, &lt;media:group&gt;, &lt;item&gt;,
 * &lt;channel&gt;.
 * </p>
 */
public class Metadata implements Cloneable, Serializable {
	 ...
	 *
	 * <p>
	 * <em>scheme</em> is the URI that identifies the categorization scheme. It
	 * is an optional attribute. If this attribute is not included, the default
	 * scheme is 'http://search.yahoo.com/mrss/category_schema'.
	 * </p>
	 *
	 * <p>
	 * <em>label</em> is the human readable label that can be displayed in end
	 * user applications. It is an optional attribute.
	 * </p>
	 *
	 * @param categories
	 ...
	 * </pre>
	 * <p>
	 * <em>url</em> is the url for a terms of use page or additional copyright
	 ...
	 * role. These should appear as distinct &lt;media:credit&gt; elements. It
	 * has 2 optional attributes.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * <em>scheme</em> is the URI that identifies the role scheme. It is an
	 * optional attribute. If this attribute is not included, the default scheme
	 * is 'urn:ebu'. See: European Broadcasting Union Role Codes.
	 * </p>
	 *
	 *
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Additional roles: <a href=
	 * "http://www.ebu.ch/en/technical/metadata/specifications/role_codes.php">European
	 ...
	 * </pre>
	 * <p>
	 * <em>type</em> specifies the type of text embedded. Possible values are
	 * either 'plain' or 'html'. Default value is 'plain'. All html must be
	 ...
	 * as long as each instance is a different <em>algo</em>. It has 1 optional
	 * attribute.
	 * </p>
	 * <p>
	 * </p>
	 ...
	 *
	 * <p>
	 * <em>algo</em> indicates the algorithm used to create the hash. Possible
	 * values are 'md5' and 'sha-1'. Default value is 'md5'. It is an optional
	 * attribute.
	 *
	 * @param hash
	 ...
	 *
	 * <p>
	 * <em>scheme</em> is the URI that identifies the rating scheme. It is an
	 * optional attribute. If this attribute is not included, the default scheme
	 * is urn:simple (adult | nonadult).
	 * </p>
	 *
	 * <p>
	 *
	 ...
	 * the feed. Currently, restrictions are based on distributor (uri) and
	 * country codes. This element is purely informational and no obligation can
	 * be assumed or implied. Only one &lt;media:restriction&gt; element of the
	 * same <em>type</em> can be applied to a media object - all others will be
	 * ignored.&nbsp;Entities in this element should be space separated. To
	 * allow the producer to explicitly declare his/her intentions, two literals
	 * are reserved: 'all', 'none'. These literals can only be used once. This
	 ...
	 *
	 * <p>
	 * <em>relationship</em> indicates the type of relationship that the
	 * restriction represents (allow | deny). In the example above, the media
	 * object should only be syndicated in Australia and the United States. It
	 ...
	 *
	 * <p>
	 * Optional element for subtitle/CC link. It contains type and language
	 * attributes. Language is based on RFC 3066. There can be more than one
	 * such tag per media element, for example one per language. Please refer to
	 * Timed Text spec - W3C for more information on Timed Text and Real Time
	 * Subtitling.
	 * </p>
	 *
	 * <pre>
	...
	public void setSubTitles(final SubTitle[] subTitles) {
		this.subTitles = subTitles == null ? new SubTitle[0] : subTitles;
	}
	 ...
	 * order based on the <em>start</em> time. Elements can have overlapping
	 * <em>start</em> and <em>end</em> times. It has 4 optional attributes.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * <em>lang</em> is the primary language encapsulated in the media object.
	 ...
	 *
	 * <p>
	 * <em>start</em> specifies the start time offset that the text starts being
	 ...
	 *
	 * <p>
	 * <em>end</em> specifies the end time that the text is relevant. If this
	 * attribute is not provided, and a <em>start</em> time is used, it is
	 * expected that the end time is either the end of the clip or the start of
	 ...
	 * 1 required attribute and 3 optional attributes.
	 * </p>
	 *
	 *
	 *
	 ...
	 * </pre>
	 * <p>
	 * <em>url</em> specifies the url of the thumbnail. It is a required
	 * attribute.
	 * </p>
	 * <p>
	 * <em>height</em> specifies the height of the thumbnail. It is an optional
	 * attribute.
	 * </p>
	 * <p>
	 * <em>width</em> specifies the width of the thumbnail. It is an optional
	 * attribute.
	 * </p>
	 *
	 *
	 * <p>
	 * <em>time</em> specifies the time offset in relation to the media object.
	 ...
	 * Play Time (NTP) as used in RTSP
	 * [<a href="http://www.ietf.org/rfc/rfc2326.txt">RFC 2326 3.6 Normal Play
	 * Time</a>]. It is an optional attribute.
	 * </p>
	 *
	 * @param thumbnail
